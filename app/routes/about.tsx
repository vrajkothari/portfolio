  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-400">Get to know me better</p>
      </div>

      {/* Bio Section */}
      <div className="bg-slate-800/50 rounded-2xl shadow-xl border border-slate-700 p-8 md:p-12 mb-12">
      ...
      {/* Interests & Hobbies */}
      <div className="bg-gradient-to-r from-cyan-600 to-emerald-600 rounded-2xl shadow-xl p-8 md:p-12 text-white">
