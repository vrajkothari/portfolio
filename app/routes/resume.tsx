            ...
            <div className="space-y-6">
              ...
              <ScrollReveal delay={100}>
                ...
                <ul className="list-disc list-inside space-y-1 text-slate-600 ml-4">
                  ...
                  <li>
                    Built AI checkout assistant using LLMs, placing 2nd out of 18 in URBN's
                    Hackathon
                  </li>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  ...
                  (Lambdas, Rekognition, S3), Git, SourceTree, Postman, Agile, Jira, Confluence,
                  Snap Lens Studio, Microsoft Office
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-slate-700 mb-1">Specializations:</h4>
                <p className="text-slate-600">
                  Machine Learning, AI/Deep Learning, Full-Stack Development, Cloud Computing,
                  AR/VR, Robotics, Computer Vision
                </p>
              </div>
            </div>
          </section>
